...
<<<<<<< HEAD:backup_and_restore/control_plane_backup_and_restore/disaster_recovery/dr-hosted-cluster-within-aws-region.adoc
...
>>>>>>> 10e554b8fb (OSDOCS#10543: Replace terms with new attributes):hosted_control_planes/hcp-backup-restore-dr.adoc
