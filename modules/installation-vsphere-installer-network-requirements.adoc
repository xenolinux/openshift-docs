...
[IMPORTANT]
====
In connected {product-title} environments, all nodes require internet access to pull images for platform containers and provide telemetry data to Red Hat.
====
