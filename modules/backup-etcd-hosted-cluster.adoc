...
To back up etcd for a hosted cluster, you need to take a snapshot of etcd and restore that snapshot.
...
. To restore the snapshot on a new cluster later, complete the following steps:
