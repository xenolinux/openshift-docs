...
To scale up and down the workloads in your hosted cluster, you can use the `ScaleUpAndScaleDown` behavior. The worker nodes scale up when you add workloads and scale down when you delete workloads.
